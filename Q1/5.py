...
for i, category in enumerate(categories):
    ...
    clusters[cluster_label].append(category)

# 输出聚类结果
for cluster_label, cluster_categories in clusters.items():
    print(f"Cluster {cluster_label + 1}: {cluster_categories}")